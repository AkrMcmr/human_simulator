...
import { decideValence, decideValenceAversion, decideValencePrivate, decideValenceDisgust, decideValenceDisgustPrivate, decideValenceOnset, decideValenceOnsetPrivate, VALENCE_VERSION, VALENCE_AVERSION_VERSION, VALENCE_DISGUST_VERSION, VALENCE_ONSET_VERSION } from "../../human/src/valence.ts";
