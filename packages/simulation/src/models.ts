...
import { decideValence, decideValenceAversion, decideValencePrivate, decideValenceDisgust, decideValenceDisgustPrivate, decideValenceOnset, decideValenceOnsetPrivate, decideValenceOnsetFast, decideValenceOnsetFastPrivate, decideValenceAlarm, VALENCE_VERSION, VALENCE_AVERSION_VERSION, VALENCE_DISGUST_VERSION, VALENCE_ONSET_VERSION, VALENCE_FAST_VERSION } from "../../human/src/valence.ts";
...
export const HUMAN_MODELS: Readonly<Record<string, HumanModel>> = Object.freeze({
  ...
  "valence-onset-0.12.0-experimental.4": { id: "valence-onset-0.12.0-experimental.4", version: VALENCE_ONSET_VERSION, role: "candidate", label: "候補 控えた嫌悪の声: 自分が毒に当たった場所の食料が見えると50ステップに1回まで悪い声を出し、自分の悪い声と同じ分類を聞いたら出所を避ける", create: createHuman, decide: decideValenceOnset, apply: applyWithIntake },
  "valence-onset-private-0.12.0-experimental.4": { id: "valence-onset-private-0.12.0-experimental.4", version: VALENCE_ONSET_VERSION, role: "control", label: "対照 控えた嫌悪の声を出すが、聞いた悪い声は採餌に使わない", create: createHuman, decide: decideValenceOnsetPrivate, apply: applyWithIntake },
  "valence-onset-fast-0.12.0-experimental.5": { id: "valence-onset-fast-0.12.0-experimental.5", version: VALENCE_FAST_VERSION, role: "candidate", label: "候補 控えた嫌悪の声（10ステップに1回まで）。自分の悪い声と同じ分類を聞いたら出所を避ける", create: createHuman, decide: decideValenceOnsetFast, apply: applyWithIntake },
  "valence-onset-fast-private-0.12.0-experimental.5": { id: "valence-onset-fast-private-0.12.0-experimental.5", role: "control", version: VALENCE_FAST_VERSION, label: "対照 同じ嫌悪の声を出すが、聞いた悪い声は採餌に使わない", create: createHuman, decide: decideValenceOnsetFastPrivate, apply: applyWithIntake },
  "valence-alarm-ceiling-0.12.0-experimental.5": { id: "valence-alarm-ceiling-0.12.0-experimental.5", role: "control", version: VALENCE_FAST_VERSION, label: "上限対照 生得の固定した警戒声（毒・嫌悪で必ず同じ音）と、その音を聞けば出所を避ける生得の理解。世界で防げる毒の上限を測る", create: createHuman, decide: decideValenceAlarm, apply: applyWithIntake },
