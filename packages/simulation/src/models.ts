...
import { decideLexicon, LEXICON_VERSION } from "../../human/src/lexicon.ts";
...
export const HUMAN_MODELS: Readonly<Record<string, HumanModel>> = Object.freeze({
  ...
  "lexicon-0.11.0-experimental.1": { id: "lexicon-0.11.0-experimental.1", version: LEXICON_VERSION, role: "candidate", label: "候補 食料と暖かい場所の2つの文脈で、経験が結びつけた聞いた声を真似、外ではどちらも避ける", create: createHuman, decide: decideLexicon, apply: applyWithIntake },
