...
[ここまでにわかったこと](docs/FINDINGS.md)に、実験で確かめた5つの発見を平易にまとめています。グラフ付きの1ページ版は[ダイジェスト](docs/digest/index.html)をブラウザで開いてください。一回の出会いを物語風に読むには次を実行します。
...
視界を狭め食料を散らした課題で、声の方向が食料への手掛かりになるかを、音なし・でたらめな方向・でたらめな特徴と比べます（[判断0014](research/decisions/0014-referential-foraging.md)）。
