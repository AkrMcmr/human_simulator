...
1. [判断0016](../research/decisions/0016-eating-coupling.md): 「食べている状態」を声に漏れる状態に加え、食後の声と探索中の声が音として分かれる条件で、選択的な定位が食後の声だけを追うことを学ぶか（種類依存）を、referential-v2の第2ラウンドのシードで測る。
