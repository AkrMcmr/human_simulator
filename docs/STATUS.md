...
1. 語彙の最小形は未成立（[判断0025](../research/decisions/0025-lexicon.md)・[0026](../research/decisions/0026-transient-warmth.md)）。世界0.4.0で暖かい場所が移り変わる条件を作り、2文脈の候補を測ったが、暖かさの声は収束も区別もせず、寒さの利益もない。診断: 暖かい場所は見つけやすく情報の非対称がないため、声の種類を割り当てる圧力が生じない。次は暖かさを希少にした世界（lexicon-v2、判断0027）。
