...
1. 語彙の最小形は未成立（[判断0025](../research/decisions/0025-lexicon.md)・[0026](../research/decisions/0026-transient-warmth.md)）。世界0.4.0で暖かい場所が移り変わる条件を作り、2文脈の候補を測ったが、暖かさの声は収束も区別もせず、寒さの利益もない。診断: 暖かい場所は見つけやすく情報の非対称がないため、声の種類を割り当てる圧力が生じない。暖かさを希少にした世界（lexicon-v2、[判断0027](../research/decisions/0027-scarce-warmth.md)）でも暖かさ側は未成立で、第2の指示対象の系統は3ラウンド連続の反証として一度止めた。成立した慣習的な合図の**新参者への伝達**（[判断0028](../research/decisions/0028-transmission.md)・[0029](../research/decisions/0029-transmission-v2.md)）: 1500ステップ目に何も知らない個体に入れ替えると、その個体の食料の声は聞ける条件で在来の声の中に6〜9割落ち（聞けない条件は1割前後、対照は0）、確認群では5項目すべて達成。開発群では新参者の空腹の2項目を外し（そのシード群では聞けない新参者がたまたま食料を見つけやすかった）未成立。16シード×2群の第2ラウンドでも確認群は5項目達成、開発群は新参者の種類依存（0.018）だけ未達。**採用（産出の伝達）は2ラウンド4群すべてで成立**（0.47〜0.70、対照0.05以下）、新参者の理解面は示唆に留まる。次は世代の連鎖（判断0030）。
