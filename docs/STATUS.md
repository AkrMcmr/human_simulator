...
1. 受け手側の合図利用は成立（[判断0020](../research/decisions/0020-referential-v5.md)）。次は発し手側と慣習: 発し手が声の結果を学ぶと何が起きるか（[判断0021](../research/decisions/0021-caller-cost.md)、実行中）、音の目録が二人以上で収束する条件（模倣）、複数の指示対象（食料と暖かさ）での声の分化。
