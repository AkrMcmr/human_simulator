...
- valence（判断0037・0038）: 毒の食料で良い声と悪い声が両群で分かれた（区別0.283 / 0.213、対照0.06未満）が確認群は閾値0.25未達、毒の利益は後ろ3分の1で0付近。診断は「避けた毒の場所が枠を占める」世界設計の副作用。世界0.6.0（腐る食料）のvalence-v2（72001–/73001–、パイロット72101–72104）を同じ閾値で事前登録。
