...
export const models: Record<string, ModelAdapter> = {
  ...
  "valence-0.12.0-experimental.1": { create: createHuman, decide: (h, o, r) => decideValence(h, o, r), apply: applyWithIntake },
  "valence-aversion-0.12.0-experimental.2": { create: createHuman, decide: decideValenceAversion, apply: applyWithIntake },
  "valence-private-0.12.0-experimental.2": { create: createHuman, decide: decideValencePrivate, apply: applyWithIntake },
  "valence-disgust-0.12.0-experimental.3": { create: createHuman, decide: decideValenceDisgust, apply: applyWithIntake },
  ...
  "valence-mirror-0.12.0-experimental.6": { create: createHuman, decide: decideValenceMirror, apply: applyWithIntake },
  "valence-mirror-private-0.12.0-experimental.6": { create: createHuman, decide: decideValenceMirrorPrivate, apply: applyWithIntake },
  "valence-mirror-0.12.0-experimental.7": { create: createHuman, decide: decideValenceMirror2, apply: applyWithIntake },
  "valence-mirror-private-0.12.0-experimental.7": { create: createHuman, decide: decideValenceMirror2Private, apply: applyWithIntake },
  "valence-assoc-0.12.0-experimental.8": { create: createHuman, decide: decideValenceAssoc, apply: applyWithIntake },
  "valence-assoc-private-0.12.0-experimental.8": { create: createHuman, decide: decideValenceAssocPrivate, apply: applyWithIntake },
  "valence-assoc-0.12.0-experimental.9": { create: createHuman, decide: decideValenceAssoc2, apply: applyWithIntake },
  "valence-assoc-private-0.12.0-experimental.9": { create: createHuman, decide: decideValenceAssoc2Private, apply: applyWithIntake },
};
